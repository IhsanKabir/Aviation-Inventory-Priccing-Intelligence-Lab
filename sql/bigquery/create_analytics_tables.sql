...
CREATE TABLE IF NOT EXISTS `__PROJECT_ID__.__DATASET__.fact_forecast_route_winner` (
  bundle_id STRING NOT NULL,
  bundle_name STRING NOT NULL,
  target STRING NOT NULL,
  stamp STRING NOT NULL,
...
CREATE TABLE IF NOT EXISTS `__PROJECT_ID__.__DATASET__.fact_backtest_route_winner` (
  bundle_id STRING NOT NULL,
  bundle_name STRING NOT NULL,
  target STRING NOT NULL,
  stamp STRING NOT NULL,
